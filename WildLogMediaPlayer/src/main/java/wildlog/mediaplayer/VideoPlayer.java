...
public class VideoPlayer {
     ...
     */
    public static void playVideo(String inFilePath, int inBoxSize) throws InterruptedException, IOException {
        ...
        // This is the Window we will display in.
        // See the code for this if you're curious, 
        // but to keep this demo clean we're 'simplifying' Java AWT UI updating code.
        // This method just creates a single window on the UI thread, and blocks until it is displayed.
                    ...
                    try {
                        ...
                        if (picture.isComplete()) {
                            image = displayVideoAtCorrectTime(
                                    streamStartTime, picture, converter, image, window, systemStartTime, systemTimeBase, streamTimebase);
                        }
                        offset += bytesRead;
                    }
                    catch (Exception ex) {
    ...
    private static BufferedImage displayVideoAtCorrectTime(long streamStartTime, final MediaPicture picture, 
            final MediaPictureConverter converter, BufferedImage image, final ImageFrame window, long systemStartTime,
