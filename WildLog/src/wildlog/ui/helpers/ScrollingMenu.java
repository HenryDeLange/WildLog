...
/**
 * Code based on example from StackOverFlow :)
 */
public class ScrollingMenu extends JPopupMenu {
    private JScrollBar popupScrollBar;
    protected int maximumVisibleRows = 25;

    public ScrollingMenu() {
        this(null);
    }

    public ScrollingMenu(String label) {
        super(label);
