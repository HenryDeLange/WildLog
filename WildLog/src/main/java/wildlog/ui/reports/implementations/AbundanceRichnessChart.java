...
public class AbundanceRichnessChart extends AbstractReport<Sighting> {
    private enum ChartType {BAR_CHART_ABUNDANCE, BAR_CHART_ELEMENT_ABUNDANCE, BAR_CHART_RICHNESS};
    private ChartType chartType;
    
    
    public AbundanceRichnessChart(List<Sighting> inLstData,JLabel inChartDescLabel, ReportsBaseDialog inReportsBaseDialog) {
