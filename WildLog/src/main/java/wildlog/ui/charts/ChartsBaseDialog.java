...
import wildlog.ui.charts.implementations.AbundanceRichnessChart;
import wildlog.ui.charts.implementations.DayAndNightChart;
...
import wildlog.ui.charts.implementations.RelationshipsChart;
import wildlog.ui.charts.implementations.SightingPropertiesChart;
import wildlog.ui.charts.implementations.SightingStatsChart;
import wildlog.ui.charts.implementations.SpeciesAccumulationChart;
import wildlog.ui.charts.implementations.TextReports;
import wildlog.ui.charts.implementations.TimeOfDayChart;
import wildlog.ui.charts.implementations.TimelineChart;
import wildlog.ui.charts.implementations.VisitChart;
...
public class ChartsBaseDialog extends JFrame {
    ...
    private AbstractChart activeReport = null;
    private int optionName;

    
    public ChartsBaseDialog(String inTitle, List<Sighting> inSightings) {
        super(inTitle);
        ...
        initComponents();
        ComboBoxFixer.configureComboBoxes(cmdElementNameOption);
    ...
    private void setupReportList() {
        ...
        List<AbstractChart<Sighting>> reports = new ArrayList<>(13);
        ...
        for (final AbstractChart<Sighting> report : reports) {
            ...
            for (Node node : report.getLstCustomButtons()) {
                if (node instanceof ToggleButton && !(node instanceof RadioButton) || node instanceof ComboBoxToShowCharts) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                if (cmdElementNameOption.getSelectedIndex() > 0) {
                    int result = WLOptionPane.showConfirmDialog(ChartsBaseDialog.this, 
    ...
    private void doFiltering(final List<Sighting> inLstOriginalData, List<Sighting> inLstFilteredData, 
            ...
            FilterProperties inLilterProperties, JLabel inLblFilteredRecords, AbstractChart inActiveReport, JFXPanel inJfxReportChartPanel) {
