...
public class CloudWorkspaceImportDialog extends JDialog {
    private final WildLogApp app;
    private int syncDataDown = 0;
    private int syncFail = 0;


    public CloudWorkspaceImportDialog(WildLogApp inApp) {
        super();
        WildLogApp.LOGGER.log(Level.INFO, "[CloudWorkspaceImportDialog]");
        app = inApp;
        initComponents();
        // Set minimum size
