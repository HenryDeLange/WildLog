...
public class WildLogAboutBox extends JDialog {
    ...
    private void initComponents() {
        ...
        lblDescription.setText("<html>Use at own risk. WildLog is developed by Henry de Lange.<br/>WildLog is a Java application and makes use of third party libraries to help with some of the functionality:  <br/>H2, SwingX, JMF, MetadataExtractor, MediaUtil, GeoTools, PDFBox, Apache POI and BalloonTip.<br/> See the application folder for license details. <br/>(Note: The media applications JPEGView and Media Player Classic - Home Cinema can be used if bundled with WildLog.)</html>");
