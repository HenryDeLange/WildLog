...
public class CloudWorkspaceListSyncDialog extends JDialog {
    private long workspaceID = 0;


    public CloudWorkspaceListSyncDialog(JDialog inParent) {
        super(inParent);
        WildLogApp.LOGGER.log(Level.INFO, "[CloudWorkspaceListSyncDialog]");
        initComponents();
            ...
            if (WildLogApp.WILDLOG_APPLICATION_TYPE == WildLogApplicationTypes.WILDLOG_WEI_REMOTE) {
                ...
                if (workspaceIDString == null || workspaceIDString.trim().isEmpty()) {
                    SwingUtilities.invokeLater(new Runnable() {
                        @Override
                        public void run() {
                            WLOptionPane.showMessageDialog(CloudWorkspaceListSyncDialog.this,
