...
public class WildLogWEIGettingStartedDialog extends JDialog {

    public WildLogWEIGettingStartedDialog() {
        super();
        WildLogApp.LOGGER.log(Level.INFO, "[WildLogWEIGettingStartedDialog]");
        initComponents();
