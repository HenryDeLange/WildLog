...
// FIXME: Hierdie is handig, maar kan baie stadig word binne groot FOR loops...
    ...
    private String getHtmlContent(boolean inIncludeImages, boolean inIsSummary, WildLogApp inApp, UtilsHTMLExportTypes inExportType, ProgressbarTask inProgressbarTask) {
        ...
        html.append("<b><u>Observation ID: ").append(UtilsHTML.formatObjectAsString(id)).append("</u></b>");
        html.append("<br/>");
        UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Creature:</b><br/>", cachedElementName, true);
        UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Place:</b><br/>", cachedLocationName, true);
        if (!inIsSummary) {
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Period:</b><br/>", cachedVisitName, true);
        }
        UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Date:</b><br/>", UtilsHTML.formatDateAsString(date, true), true);
        if (!inIsSummary) {
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Date and Time Accuracy:</b><br/>", timeAccuracy, true);
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Time of Day:</b><br/>", timeOfDay, true);
        }
        if (!inIsSummary) {
        ...
        UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Certainty:</b><br/>", certainty, true);
        UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Life Status:</b><br/>", lifeStatus, true);
        if (!inIsSummary) {
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Evidence:</b><br/>", sightingEvidence, true);
        }
        if (numberOfElements > 0) {
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Number of Creatures:</b><br/>", numberOfElements, true);
        }
        UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Details:</b><br/>", details, true);
        if (!inIsSummary) {
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Gender:</b><br/>", sex, true);
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Age:</b><br/>", age, true);
            if (moonPhase >= 0) {
                UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Moon Phase:</b><br/>", moonPhase + " % Full", true);
            }
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Moonlight:</b><br/>", moonlight, true);
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Weather:</b><br/>", weather, true);
            if (unitsTemperature != null && !UnitsTemperature.NONE.equals(unitsTemperature)) {
                UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Temperature:</b><br/>", temperature + " " + unitsTemperature, true);
            }
            if (durationMinutes > 0 || durationSeconds > 0) {
                UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>Duration:</b><br/>", durationMinutes + " minutes, " + durationSeconds + " seconds", true);
            }
        }
        if (!inIsSummary) {
            UtilsHTML.appendIfNotNullNorEmpty(html, "<br/><b>View Rating:</b><br/>", viewRating, true);
        }
        if (!inIsSummary) {
