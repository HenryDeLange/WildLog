...
public class MapsBaseDialog extends JFrame {
    ...
    public MapsBaseDialog(String inTitle, List<Sighting> inSightings, String inElementName) {
        super(inTitle);
    ...
    private void setupReportList() {
        ...
        lstMaps.add(new DistributionMap(lstFilteredData, elementName, lblMapDescription, this));
