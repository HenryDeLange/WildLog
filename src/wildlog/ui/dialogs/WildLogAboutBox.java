...
public class WildLogAboutBox extends JDialog {
    ...
    private void initComponents() {
        ...
        lblDescription.setText("<html>Use at own risk. WildLog is developed by Henry de Lange.<br/>WildLog is a Java application and makes use of third party libraries to help with some of the functionality: GeoTools, H2, SwingX, JMF, MetadataExtractor, MediaUtil, PDFBox and Apache POI. See the application folder for license details.</html>");
